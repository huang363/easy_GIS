...
void drawtext(float xc, float yc, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool centered = true);
void drawtext(const t_point& text_center, const std::string& text, float boundx=FLT_MAX, float boundy=FLT_MAX, bool centered=true);
void drawtext(const t_point& text_center, const std::string& text, const t_bound_box& bounds, bool centered=true);
void drawtext(
        const t_point& text_center, const std::string& text, const t_bound_box& bounds, float tolerance, bool centered=true);

void drawtext_in(const t_bound_box& bbox, const std::string& text, bool centered=true);
void drawtext_in(const t_bound_box& bbox, const std::string& text, float tolerance, bool centered=true);
...
t_transform_coordinates get_trans_coord();
